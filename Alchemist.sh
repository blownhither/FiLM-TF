...
#ssh "$MACHINE" "screen -S myFilm -dm bash -c \
#        '$LD_EXPORT; cd $REMOTE_DIR; $REMOTE_PY film.py --train_questions=$TRAIN_QUESTIONS
#        --tokenizer_path=$TRAIN_TOKENIZER --image_dir=$TRAIN_IMAGE_DIR 2>&1 | tee film.log' "
